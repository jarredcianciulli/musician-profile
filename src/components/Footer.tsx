  ...
  return (
    <footer className="bg-ink text-paper">
      <div className="section-container py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            <LogoLockup
              ...
              showInstructor
              className="mb-4"
              markClassName="w-7 h-12 text-sky shrink-0"
            />
            <p className="text-paper/60 mb-4 max-w-md">
              {brand.tagline}. Private instruction for students of all ages in{" "}
        ...
        <div className="border-t border-white/10 mt-8 pt-8 text-center text-paper/40 text-sm">
          <p>
